...
// 回归
reg lnIncome hukou_dm_lnPEE hukou lnPEE gender nation married parents_edu
outreg2 using jia2024.tex, replace addt(出生年份固定效应, 否, 城市固定效应, 否, 调查年份固定效应, 否, 城市×出生年份固定效应, 否)
reghdfe lnIncome hukou_dm_lnPEE hukou lnPEE gender nation married parents_edu, absorb(birthyear)
outreg2 using jia2024.tex, append addt(出生年份固定效应, 是, 城市固定效应, 否, 调查年份固定效应, 否, 城市×出生年份固定效应, 否)
reghdfe lnIncome hukou_dm_lnPEE hukou lnPEE gender nation married parents_edu, absorb(birthyear citycode year)
outreg2 using jia2024.tex, append addt(出生年份固定效应, 是, 城市固定效应, 是, 调查年份固定效应, 是, 城市×出生年份固定效应, 否)
reghdfe lnIncome hukou_dm_lnPEE hukou lnPEE gender nation married parents_edu, absorb(i.birthyear#i.citycode year)
