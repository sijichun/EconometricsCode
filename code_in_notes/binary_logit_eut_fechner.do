// binary_logit_eut_fechner.do
clear
set more off
* define Original Recipe EUT with CRRA and Fechner errors
global link "Probit"
cap program drop ML_eut_fechner
program define ML_eut_fechner
    args lnf r sigma
...
ml model lf ML_eut_fechner (r: Choices P0left P1left P2left P3left P0right P1right P2right P3right prize0 prize1 prize2 prize3 stake = ,freeparm) /sigma if Choices~=., cluster(id) technique(bfgs) 
ml maximize